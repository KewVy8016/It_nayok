...
@section('title', 'เเผนการเรียน ปวส.')
...
@section('content')
    ...
    <div class="container mt-5">
        <!-- หัวข้อของเมนู -->
        <h2>ประกาศนียบัตรวิชาชีพชั้นสูง (ปวส.) สาขาวิชา เทคโนโลยีสารสนเทศ</h2>
                ...
                <div class="accordion-item m-3">
                    ...
                    <div id="collapse{{ $loop->index }}" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-body">
                            ...
                            <div class="mt-3">
                                <a href="{{ asset('storage/' . $plan->pathfile) }}" class="btn btn-primary" download>
